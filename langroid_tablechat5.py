...
def main():
    parser = argparse.ArgumentParser(description="TableChatAgent CLI")
    parser.add_argument("--data", type=str, required=True, help="Path to the data file")
    parser.add_argument("--separator", type=str, help="Separator for the data file")
    ...
    console.print("TableChatAgent initialized and ready for queries.")
    while True:
        query = input("Ask your question about the data (or type 'exit' to quit): ")
        if query.lower() == 'exit':
            break
        response = agent.user_response(query)
        if response:
